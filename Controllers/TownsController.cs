...
namespace OrdersSystem.Controllers
{
    public class TownsController : Controller
    {
        ...
        public TownsController(OrderSystemDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TownId,TownName,TownPostCode")] Town town)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TownId,TownName,TownPostCode")] Town town)
        {
            if (id != town.TownId)
            {
                return NotFound();
