...
{
    public partial class OrderSystemDatabaseContext_Old : DbContext
    {
        public OrderSystemDatabaseContext_Old()
        {
            this.ChangeTracker.LazyLoadingEnabled = false;
        }

        public OrderSystemDatabaseContext_Old(DbContextOptions<OrderSystemDatabaseContext> options)
            : base(options)
        {
            this.ChangeTracker.LazyLoadingEnabled = false;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Street>(entity =>
            {
                ...
                entity.HasOne(d => d.Town)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Street_Town");
            });
